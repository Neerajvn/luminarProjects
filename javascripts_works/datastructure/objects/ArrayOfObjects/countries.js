...
//print all countryname
// myCountries.map(data=>data.countryName).forEach(names=>console.log(names))


//print india full details

// let indiaData=myCountries.find(data=>data.countryName=="India")
// console.log(indiaData);

//print china currency

// let chinaCurrency=myCountries.find(data=>data.countryName=="China").currencyName
// console.log(chinaCurrency);

//print population above 2 cr
let crPopulation=myCountries.filter(data=>data.population==20000000).map(cntry=>cntry.countryName).forEach(name=>console.log(name))
